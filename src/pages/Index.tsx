        ...
        <div className="container mx-auto px-4 py-16 md:py-24 relative z-10">
          <div className="max-w-4xl mx-auto text-center space-y-8">
            <div className="space-y-6 animate-fade-in">
              <div className="inline-block px-4 py-2 rounded-full bg-primary/10 border border-primary/20 mb-4 backdrop-blur-sm">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center animate-fade-in" style={{ animationDelay: "0.2s" }}>
              ...
              <Button
                ...
                className="gap-2 text-lg px-8 border-2 backdrop-blur-sm"
              >
                Já tenho conta
              </Button>
            </div>
            ...
            <div id="features" className="grid md:grid-cols-3 gap-6 mt-20 animate-fade-in" style={{ animationDelay: "0.4s" }}>
              <div className="bg-card/90 backdrop-blur-md p-8 rounded-2xl shadow-card border border-border/50 hover:shadow-lg transition-all hover:scale-105">
